...
def model(dbt, session):
    dbt.configure(materialized='ephemeral')
...
class this:
    ...
    database = "njc-ezpass"
    schema = "ezpass_data"
    identifier = "_silver__holiday_flag"
    
    def __repr__(self):
        return 'njc-ezpass.ezpass_data._silver__holiday_flag'
...
df.write \
  ...
  .save("njc-ezpass.ezpass_data._silver__holiday_flag")
